# Code from https://fastapi.metacpan.org/source/GRANTM/Encoding-FixLatin-1.04/lib/Encoding/FixLatin.pm, with XS removed
package FixLatin;
{
  $FixLatin::VERSION = '1.04';
}
...
FixLatin - takes mixed encoding input and produces UTF-8 output


=head1 SYNOPSIS

    use FixLatin qw(fix_latin);
...
C<fix_latin> is used.  Note, the L<FixLatin::XS> module must be
...
'auto' is the default behaviour - if L<FixLatin::XS> is installed, it
