# test the exporting of variables from another package.  This version uses require and doesn't import anything and refers to everything
# with the package name.
# pragma pythonizer no implicit global my

use Carp::Assert;
require "./ExportVars.pm";
