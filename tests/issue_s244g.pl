# issue s244g - Use of struct generates code with syntax error - this test defines defines the struct on the 'use' with an array
use Carp::Assert;
#use lib '.';
use Class::Struct Car => [make => '$', model => '$', year => '$', features => '%', previous_owners => '@', address => 'Address'];
