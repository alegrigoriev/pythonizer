# issue s244e - Use of struct generates code with syntax error - this test defines a package outside of the struct call and defined the struct on the 'use'
use Carp::Assert;
#use lib '.';
package Car;
use Class::Struct make => '$', model => '$', year => '$', features => '%', previous_owners => '@', address => 'Address';
