# perllib module for pythonizer, generated by makelib.py on Thu Jan  5 23:29:27 2023
#
...
_TIE_MAP = {'DESTROY': '__del__','PUSH': 'append','CLEAR': 'clear','SCALAR': '__len__','FETCH': '__getitem__','EXISTS': '__contains__','DELETE': '__delitem__','UNTIE': '__untie__','STORE': '__setitem__','FETCHSIZE': '__len__'}
TRACEBACK = 0
LIST_SEPARATOR = ' '
EVAL_ERROR = ''
CHILD_ERROR = 0
INPUT_LAYERS = ''
_PYTHONIZER_KEYWORDS = {'sorted','struct','float','Hash','if','functools','ArrayHash','set','help','True','map','format','with','calendar','object','signal','fileinput','import','ascii','min','types','aiter','pass','bytes','rstrip','else','open','from','max','tuple','builtins','False','close','for','property','sum','id','try','int','globals','staticmethod','print','break','memoryview','except','classmethod','ord','enumerate','type','breakpoint','nonlocal','tm_py','elif','stat','math','len','issubclass','update','delattr','is','getattr','isinstance','lambda','super','itertools','getopt','input','return','extend','pdb','pow','perllib','traceback','anext','any','bin','bool','chr','keys','subprocess','while','upper','async','hash','eval','atexit','oct','reversed','abs','lower','range','hex','iter','slice','assert','locals','zip','repr','frozenset','complex','casefold','get','insert','re','raise','await','all','glob','warnings','argparse','dataclasses','del','dir','class','next','copy','as','finally','random','setattr','compile','collections.abc','continue','fcntl','vars','None','str','hasattr','wantarray','find','Array','sys','def','exec','global','inspect','dict','divmod','rfind','bytearray','filter','in','or','round','yield','callable','pop','io','not','list','values','os','and','codecs','tempfile'}
OS_ERROR = ''
OUTPUT_LAYERS = ''
