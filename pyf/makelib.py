...
def main():
    ...
    def under_return_repl(m):
        """Remove underscores from function names in return statements"""
        func = m.group(1)
        result = func[1:]
        if keyword.iskeyword(result) or hasattr(builtins, result):
            result += '_'
    ...
    with open(OUTPUT_FILE, 'w') as of:
        ...
        print(file=of)
        print('import sys,os,re,fileinput,subprocess,collections.abc,warnings,inspect,itertools,signal,traceback,io,tempfile,calendar,types,random,dataclasses,builtins,codecs,struct,pprint,functools,argparse,keyword', file=of)
        ...
        for file in files:
            ...
            with open(file, 'r') as fh:
                for line in fh:
                    ...
                    line = re.sub(under_functions_return_regex, under_return_repl, line)
