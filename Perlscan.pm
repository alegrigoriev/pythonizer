   ...
   %keyword_tr=('eq'=>'==','ne'=>'!=','lt'=>'<','gt'=>'>','le'=>'<=','ge'=>'>=',
		...
		'state'=>'global',
                ...
                'read'=>'.read',                # issue 10
                   ...
                   'substr'=>'','sub'=>'def','STDERR'=>'sys.stderr','SYSIN'=>'sys.stdin',
...
#    in_string=1 - we are decoding in a string and $xxx [0] is different than $xxx[0]
{
my $source=$_[0];
